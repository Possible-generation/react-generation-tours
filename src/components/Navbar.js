...
export default function Navbar() {
  return (
    <nav className='bg-slate-800 p-2 flex w-full items-center '>
      ...
      <h6 className='font-bold text-4xl text-blue-400 pl-2 font-serif'>GT</h6>
      <ul className=' text-center grid  grid-cols-3 pb-2 font-sans text-lg mx-auto space-x-10  md:space-x-60 text-white cursor-pointer'>
